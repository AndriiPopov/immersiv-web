      ...
      <div className={isMobile ? styles.flex1 : styles.wrap}>
        ...
        <div className={isMobile ? styles.flex1 : styles.center}>
          ...
          <div className={isMobile ? styles.flex1 : styles.viewWrap}>
            <div className={isMobile ? styles.flex1 : styles.viewInner}>
          ...
          <div className={styles.bottomWrap}>
            ...
            <div className={styles.bottomCenter}>
              ...
              <div className={styles.bottomCenterRight}>
                <a href={`tel:${constant.call}`} className={styles.contactWrap}>
                  <div className={styles.contactIconWrap}>
                    <PhoneFilled name="phone" className={styles.contactIcon} />
                  </div>
                  <div style={{ width: "10px" }}></div>
                  <div className={styles.contactText}>{constant.phone}</div>
                </a>
                ...
                >
                  ...
                  <div style={{ width: "10px" }}></div>
                  <div className={styles.contactText}>{constant.email}</div>
                </a>
              </div>
            </div>
            <PoweredLogo invisible />
